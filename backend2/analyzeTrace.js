...
var downloadAndExtractTrace = function (traceZipUrl, outputDir) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, new Promise(function (resolve, reject) {
                        writer.on("finish", function () { return resolve(undefined); });
...
var parseTrace = function (outputDir) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        actions = lines.filter(function (entry) { return entry.type === "action"; });
        lastError = __spreadArray([], lines, true).reverse()
            .find(function (entry) { var _a, _b; return (_b = (_a = entry.metadata) === null || _a === void 0 ? void 0 : _a.error) === null || _b === void 0 ? void 0 : _b.message; });
        return [2 /*return*/, {
...
var runAnalysis = function () { return __awaiter(void 0, void 0, void 0, function () {
    var traceZipUrl, outputDir, result, err_1;
    var _a, _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                traceZipUrl = "https://assets-cdn.neetoplaydash.com/rails/active_storage/blobs/proxy/eyJfcmFpbHMiOnsiZGF0YSI6ImYzYTg4YmU3LWQ1MDgtNDE1Yi05NThhLWE0MzFjYjI4ZDdmYiIsInB1ciI6ImJsb2JfaWQifX0=--82f879f8b5b825282baaf40a03a20af18257798e/-home-neetoci-neeto-invoice-web-playwright-tests-test-results-invoice-Verify-invoices-sh-b6847-oice-email-and-invoice-link-chromium-retry1-trace.zip";
            ...
            case 3:
                ...
                if ((_c = (_b = (_a = result.lastError) === null || _a === void 0 ? void 0 : _a.metadata) === null || _b === void 0 ? void 0 : _b.error) === null || _c === void 0 ? void 0 : _c.message) {
